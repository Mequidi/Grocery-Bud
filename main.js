...
window.addEventListener("DOMContentLoaded",setupItemsFromLocalStorage);
...
function clearBox() {
    ...
    if (items.length > 0) {
        ...
        container.classList.remove("show-container");
        displayMessage("items removed", "success");
        setBackToDefault();
        localStorage.removeItem("list");
    } else
        displayMessage("No items to be removed", "danger");
...
function setupItemsFromLocalStorage(){
    let items = getLocalStorage();
